...
def print_loss_graph(epoch_list, loss_list, name):
  plt.plot(epoch_list, loss_list)
  plt.xlabel('Epoch')
  plt.ylabel('Average Training Loss')
  plt.title('Average Model Loss over Training Period')
  plt.savefig(name)
...
if __name__ == '__main__':
    ...
    epoch_list = [*range(1, 501, 1)]
    print_loss_graph(epoch_list, losses, 'baseline_net.png') 
